...
def cumulativeReturnPlot(DRL_returns, equalWeight_returns, minVariance_returns, all_stock, all_debt, all_reit):
    drl_cumpod =(DRL_returns+ 1).cumprod()-1
    # cumpod_82 =(returns_82+ 1).cumprod()-1
    ...
    trace0_portfolio = go.Scatter(x = time_ind, y = drl_cumpod, mode = 'lines', name = 'RL+BL(Ours)')
    # trace1_portfolio = go.Scatter(x = time_ind, y = cumpod_82, mode = 'lines', name = 'stock(8)debt(2)')
    trace2_portfolio = go.Scatter(x = time_ind, y = equal_cumpod, mode = 'lines', name = 'Equal Weight')
    trace3_portfolio = go.Scatter(x = time_ind, y = min_var_cumpod, mode = 'lines', name = 'Min Variance')
    trace4_portfolio = go.Scatter(x = time_ind, y = stock_cumpod, mode = 'lines', name = '100% stock ETF')
    trace5_portfolio = go.Scatter(x = time_ind, y = debt_cumpod, mode = 'lines', name = '100% debt ETF')
    trace6_portfolio = go.Scatter(x = time_ind, y = reit_cumpod, mode = 'lines', name = '100% reit ETF')
